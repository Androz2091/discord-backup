 ...
 */
function channels(guild, backupData) {
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            backupData.channels.categories.forEach(function (categoryData) {
                util_1.loadCategory(categoryData, guild).then(function (createdCategory) {
                    categoryData.children.forEach(function (channelData) {
                        util_1.loadChannel(channelData, guild, createdCategory);
                    });
                });
            });
            backupData.channels.others.forEach(function (channelData) {
                util_1.loadChannel(channelData, guild, null);
            });
            return [2 /*return*/];
        });
    });
...
function afk(guild, backupData) {
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            if (backupData.afk) {
                guild.setAFKChannel(guild.channels.find(function (ch) { return ch.name === backupData.afk.name; }));
        ...
        return __generator(this, function (_a) {
            if (backupData.embed.channel) {
                guild.setEmbed({
                    ...
                    channel: guild.channels.find(function (ch) { return ch.name === backupData.embed.channel; })
                });
            }
            return [2 /*return*/];
        });
